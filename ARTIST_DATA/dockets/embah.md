...
- None found (died 2015; no personal site located).
...
- Best of Trinidad profile (Emheyo Bahabba): http://www.bestoftrinidad.com/profiles/bahabba.html
- White Columns exhibition pages (bio in both): https://whitecolumns.org/exhibitions/embah/ and https://whitecolumns.org/exhibitions/white-room-emheyo-bahabba/

## Shown at (up to 5)

- [White Columns, New York](https://whitecolumns.org/exhibitions/embah/) — "Embah" exhibition; also earlier "White Room: Emheyo Bahabba"
- [The National Museum of Trinidad and Tobago](https://darlenprojects.blogspot.com/2015/09/embahs-art-national-museum-of-trinidad.html) — per DArlen Projects legacy essay
- [The Studio Museum in Harlem](https://www.studiomuseum.org/artists/embah) — "Jurisprudence" (2006) in the permanent collection (gift of Martin and Rebecca Eisenberg)
...
- Key research fact: "Embah" is the working name of **Emheyo Bahabba** — search under both names (the full name unlocks most sources).
- Trinidadian press (Guardian, Newsday) covers him well; US coverage runs through White Columns.
