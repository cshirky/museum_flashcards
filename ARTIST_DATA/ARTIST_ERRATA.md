...
Artists formerly listed in `ARTIST_IMAGE_NOWIKI.md` whose Wikipedia pages were found by hand (the automatic matcher in fetch_data.py missed them because Wikipedia titles the page differently, the museum's spelling differs, or the name lands on a namesake/disambiguation page), plus museum-side duplicate/alternate artist entries for people the collection already lists under another spelling or name (their Notes say which entry is canonical). Each hand-found match is recorded in `MANUAL_WIKI_MATCHES` in wiki_match.py and applied to the app's data files; the Notes line keeps the rationale for the match. Unnumbered, sorted by last name as elsewhere.

## Francisco Alvaroado-Juarez
...
- Notes: Museum-side duplicate ("Alvaroado" typo) of flashcards artist Francisco Alvarado-Juárez (b. 1950).

## Antony Charles Robert Armstrong-Jones

- Dates: 1930–2017
- [Wikipedia](https://en.wikipedia.org/wiki/Antony_Armstrong-Jones,_1st_Earl_of_Snowdon)
...
- Dates: —
- [Wikipedia](https://en.wikipedia.org/wiki/Endia_Beal)
...
- Dates: —
- [Wikipedia](https://en.wikipedia.org/wiki/Carole_Byard)
...
- Notes: Museum-side alternate of our Carol Byard, already wiki-matched.

## Bourmand Byron

- Dates: 1920–2004
- [Wikipedia](https://en.wikipedia.org/wiki/Bourmond_Byron)
...
- Notes: Museum-side duplicate (punctuation variant) of flashcards artist T.J. Dedeaux-Norris.
...
- Dates: —
- [Wikipedia](https://en.wikipedia.org/wiki/Thornton_Dial)
...
- [Wikipedia](https://en.wikipedia.org/wiki/Frohawk_Two_Feathers)
- [Search Google](https://www.google.com/search?q=Frohawk%20Two%20Feathers%20artist)
- Notes: Museum-side alias-only duplicate of flashcards artist Umar Rashid (Frohawk Two Feathers), already wiki-linked in the app.

## Herbert Alexander Gentry

- Dates: 1919–2003
- [Wikipedia](https://en.wikipedia.org/wiki/Herbert_Gentry)
...
- Dates: 1918–2013
- [Wikipedia](https://en.wikipedia.org/wiki/J._Eugene_Grigsby)
...
- Dates: b. 1946
- [Wikipedia](https://en.wikipedia.org/wiki/Chester_Higgins_Jr.)
...
- Notes: Museum-side duplicate: correct-spelling entry for flashcards artist "Feburary James" (artwork credits carry the typo).

## Dana C. Chandler Jr.

- Dates: 1941–2025
- [Wikipedia](https://en.wikipedia.org/wiki/Dana_Chandler)
...
- Dates: b. 1946
- [Wikipedia](https://en.wikipedia.org/wiki/Earlie_Hudnall,_Jr.)
...
- Dates: 1935–2005
- [Wikipedia](https://en.wikipedia.org/wiki/Alvin_D._Loving)
...
- [Wikipedia](https://en.wikipedia.org/wiki/Tracey_Moffatt)
- [Search Google](https://www.google.com/search?q=Tracey%20Moffat%20artist)
- Notes: Museum-side duplicate (single-t) of flashcards artist Tracey Moffatt, already wiki-linked in the app.

## J. B. Murray

- Dates: 1908–1988
- [Museum page](https://www.studiomuseum.org/artists/j-b-murray)
- [Wikipedia](https://en.wikipedia.org/wiki/John_Bunion_Murray)
- [Search Google](https://www.google.com/search?q=J.%20B.%20Murray%20artist)
- Notes: Museum-side duplicate (spacing variant) of flashcards artist J.B. Murray, already wiki-linked in the app (article: John Bunion Murray).
...
- Notes: Museum-side duplicate ("Newsom" typo) of Rashaad Newsome (b. 1979), whose entry carries a Wikipedia match proposal in ARTIST_NOIMAGE_WIKI.md.
...
- Notes: Museum-side duplicate (short-name entry) of Leonel López-Nussa (1916–2004), whose full-name entry remains in ARTISTS_NOIMAGE_NOWIKI.md.

## P.H. Polk

- Dates: 1898–1984
- [Wikipedia](https://en.wikipedia.org/wiki/P._H._Polk)
...
- Dates: b. 1975
- [Wikipedia](https://en.wikipedia.org/wiki/Robert_Pruitt_%28artist%29)
...
- Dates: 1903–1983
- [Wikipedia](https://en.wikipedia.org/wiki/Jeanne_Reynal)
...
- Notes: Museum-side alternate of our Mallica Kapo Reynolds, already wiki-matched.
...
- Notes: Museum-side duplicate: correct-spelling entry for flashcards artist "Michel Sivnil" — Haitian papier-mâché sculptor, b. 1949 Jacmel; research in dockets/michel-sivnil-2.md.

## Dr.Charles Smith

- Dates: —
- [Wikipedia](https://en.wikipedia.org/wiki/Dr._Charles_Smith)
...
- Dates: 1920–2006
- [Wikipedia](https://en.wikipedia.org/wiki/Mose_Tolliver)
...
- Notes: Museum-side duplicate: correct-spelling artist-list entry for flashcards artist "Rachel Eulena Willliams" (artwork credits carry the triple-l typo).
...
- [Wikipedia](https://en.wikipedia.org/wiki/Frank_Wimberley)
- [Search Google](https://www.google.com/search?q=Frank%20Wimberley%20artist)
- Notes: Museum-side alternate of our Frank Wimberly, already wiki-matched.
